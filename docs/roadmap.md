...
Ship a reusable autonomy-loop toolkit that can be adopted across repositories
without coupling to any single product codebase.

## Milestones

### M1: Toolkit Bootstrap (Done)

- package scaffold and CLI
- reusable runner, validator, memory modules
